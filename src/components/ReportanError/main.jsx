...
import {
    FormControl, FormLabel, Input, Button, ModalContent, ModalHeader, Spinner, Modal, ModalOverlay, Textarea, Tabs, TabPanels, TabList, TabPanel, Tab, Select, Box, Radio, RadioGroup, Collapse, ModalBody, Text
                                    ...
                                    <TabPanels className="container">
                                        ...
                                        <TabPanel>
                                            <FormControl mt={10} isRequired>
                                                ...
                                                <RadioGroup isInline spacing={4} name="devicetype" value={form.device} onChange={value => { setDevice(value); setActiveButton(value) }}>
                                            ...
                                            <FormControl mt={10} isRequired>
                                                ...
                                                <Select name="browser" value={form.browser} onChange={onChange} variant="flushed">                     {deviceList.browsers.map(item => <option key={item} value={item}>{item}</option>)}
                                                </Select>
                                            </FormControl>
                                            <FormControl mt={10} isRequired>
                                                ...
                                                <datalist id="os">
                                                    {deviceList.os.map(item => <option key={item} value={item}></option>)}
                                                </datalist>
                                            </FormControl>
